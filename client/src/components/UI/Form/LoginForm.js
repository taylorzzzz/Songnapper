	...
	validateField(name, value) {
		...
		switch (name) {
			...
			case 'password': 
				...
				fieldValidationErrors.password = getPasswordValidationErrors
				(value);
		...
		return (
			...
			<form>
				...
				<div className={classes.TextInput}>
					...
					<div className={classes.ValidationAdvice}>

						{this.state.formErrors.email.join(' ')}
				...
				<div className={classes.TextInput}>
					...
					<div className={classes.ValidationAdvice}>
						...
						{this.state.formErrors.password.join(' ')}
