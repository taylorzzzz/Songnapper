...
const userTabs = props => {
	...
	return (
		<div className={classes.UserTabs}>	
			<div className={ connectionsClasses.join(' ') } onClick={() => props.clicked('connections')}>Submitted Connections</div>
			<div className={ commentsClasses.join(' ') } onClick={() => props.clicked('comments')}>Comments</div>
			<div className={ likesClasses.join(' ') } onClick={() => props.clicked('likes')}>Likes</div>
		</div>
	)
}
